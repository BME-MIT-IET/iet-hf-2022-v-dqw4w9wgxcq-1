...
public class SkolemizerPrimaryTopicCucumberTest {
    ...
    public void the_excepted_skolemizer_of_primary_topic_skolemizer_test() {
    ...
    public void the_actual_skolemizer_is_gave_of_primary_topic_skolemizer_test() {
    ...
    public void the_expected_and_the_actual_skolemizer_in_primary_topic_test_are_equal() {
